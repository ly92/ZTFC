...
- (IBAction)submit:(id)sender{
    ...
    ApplyRepairAPI *applyRepairApi = [[ApplyRepairAPI alloc]initWithCommunityid:communityid unit:@"" maintype:self.maintype subtype:subtypeid content:self.txtContent.text username:self.lblName.text mobile:self.lblMobile.text address:self.txtAddress.text image:self.uploadImage];
